			...
			<div className='text'>
				...
				<div className='details d-flex mb-3'>
					...
					<p className='p-0 m-0'>
						...
						<span className='text-main-blue fw-bold'>{MovieData.adult ? 'Yes' : 'No'} /</span>
					</p>
					<p className='p-0 m-0'>
						<span className='text-white-50 p-0'>Relase: </span>
						<span className='text-main-blue fw-bold'>{MovieData?.release_date}</span>
					</p>
				</div>
				...
				<Link className='btn main-bg text-white ' to={`/movie/${MovieData.id}`}>
					<FontAwesomeIcon icon={faCircleInfo} style={{ marginRight: 5 }} />
					Detils
				</Link>
			</div>
		</section>
